...
class QuestionCreateScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final explanationFocusnode = FocusNode();
    final corAnsFocusnode = FocusNode();

    final titleController = TextEditingController();
    final markController = TextEditingController();
    final explanationController = TextEditingController();
    final corAnsController = TextEditingController();

    return BlocBuilder<QuestionCreateBloc, QuestionCreateState>(
      builder: (context, state) {
        titleController.text = state.title;
        markController.text = state.mark;
        explanationController.text = state.explanation;
        corAnsController.text = state.correctAns;
        return Body(
          isFullScreen: true,
          appBar: FutureAppBar(
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          if (state.questionTypeId == 3)
                            TextFieldB(
                              fieldTitle: LocaleKeys.corAns.tr(),
                              hintText: LocaleKeys.enterCorAns.tr(),
                              borderColor: bGray12,
                              focusNode: corAnsFocusnode,
                              controller: corAnsController,
                              onChanged: (String value) {
                                bloc.add(ChangeCorAns(corAns: value));
                              },
                            ),
