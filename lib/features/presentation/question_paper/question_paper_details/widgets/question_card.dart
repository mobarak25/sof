...
class QuestionCard extends StatelessWidget {
  const QuestionCard({
    super.key,
    required this.questionPaperContents,
  });
    ...
    return Column(
      children: [
        ...List.generate(
          ...
          (index) {
            final file =
                questionPaperContents[index].questions!.attachment!.file!;
              ...
              child: Theme(
                ...
                child: ExpansionTile(
                  ...
                  children: [
                    ...
                    const Gap(10),
                    if (questionPaperContents[index].questions!.type != 3)
                      GridView.builder(
                        shrinkWrap: true,
                            ...
                            child: Container(
                              ...
                              child: ButtonB(
                                ...
                                bgColor: option[position].isCorrect == 1
                                    ? kPrimaryColor
                                    : bWhite,
                                borderColor: option[position].isCorrect == 1
                                    ? kPrimaryColor
                                    : bGray12,
